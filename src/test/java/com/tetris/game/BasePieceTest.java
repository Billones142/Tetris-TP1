...
public class BasePieceTest {
    ...
    @Test
    public void collided_test(){
        PieceL test= new PieceL();

        assertFalse(test.getHasCollided());

        test.collided();

        assertTrue(test.getHasCollided());
    }

    @Test
    public void getMatrix_test(){
        TestPiece test = new TestPiece();

        assertNull(test.getMatrix());
        
    }

    @Test
    public void maxVariations_test(){
        ...
        assertEquals(1,dog.getMaxVariations());
        assertEquals(2,l.getMaxVariations());
        assertEquals(0,square.getMaxVariations());
        assertEquals(0,stick.getMaxVariations());
        assertEquals(0,t.getMaxVariations());
    }
}